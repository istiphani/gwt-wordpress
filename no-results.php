...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php _e( 'Nothing Found', 'gwt_wp' ); ?></h1>
	</header>
	...
	<div class="page-content">
		...
		<?php else : ?>
			...
			<p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Please try again with different keywords.', 'gwt_wp' ); ?></p>
			<?php get_search_form(); ?>
